...
public class CreateAagamesData {
	public void createTestData() throws PersistentException {
		...
		try {
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : games, ID
			pt.uminho.di.aa.UserDAO.save(lptuminhodiaaUser);
			pt.uminho.di.aa.Game lptuminhodiaaGame = pt.uminho.di.aa.GameDAO.createGame();
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : price, year, ID, platform
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : games, year, ID
