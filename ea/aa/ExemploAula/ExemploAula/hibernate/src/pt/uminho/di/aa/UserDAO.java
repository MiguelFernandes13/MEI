...
public class UserDAO {
	...
	public static User loadUserByORMID(PersistentSession session, int attribute) throws PersistentException {
		try {
			return (User) session.load(pt.uminho.di.aa.User.class, Integer.valueOf(attribute));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, int attribute) throws PersistentException {
		try {
			return (User) session.get(pt.uminho.di.aa.User.class, Integer.valueOf(attribute));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User loadUserByORMID(PersistentSession session, int attribute, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.load(pt.uminho.di.aa.User.class, Integer.valueOf(attribute), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static User getUserByORMID(PersistentSession session, int attribute, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (User) session.get(pt.uminho.di.aa.User.class, Integer.valueOf(attribute), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUser(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From pt.uminho.di.aa.User as User");
		if (condition != null)
	...
	public static User createUser() {
		return new pt.uminho.di.aa.User();
	}
	
	public static boolean save(pt.uminho.di.aa.User user) throws PersistentException {
		try {
			AagamesPersistentManager.instance().saveObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(pt.uminho.di.aa.User user) throws PersistentException {
		try {
			AagamesPersistentManager.instance().deleteObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(pt.uminho.di.aa.User user) throws PersistentException {
		try {
			AagamesPersistentManager.instance().getSession().refresh(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(pt.uminho.di.aa.User user) throws PersistentException {
		try {
			AagamesPersistentManager.instance().getSession().evict(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
