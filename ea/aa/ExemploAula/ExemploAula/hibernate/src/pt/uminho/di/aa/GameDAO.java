...
public class GameDAO {
	public static Game loadGameByORMID(int attribute) throws PersistentException {
		try {
			PersistentSession session = AagamesPersistentManager.instance().getSession();
			return loadGameByORMID(session, attribute);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Game getGameByORMID(int attribute) throws PersistentException {
		try {
			PersistentSession session = AagamesPersistentManager.instance().getSession();
			return getGameByORMID(session, attribute);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game loadGameByORMID(int attribute, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = AagamesPersistentManager.instance().getSession();
			return loadGameByORMID(session, attribute, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game getGameByORMID(int attribute, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = AagamesPersistentManager.instance().getSession();
			return getGameByORMID(session, attribute, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game loadGameByORMID(PersistentSession session, int attribute) throws PersistentException {
		try {
			return (Game) session.load(pt.uminho.di.aa.Game.class, Integer.valueOf(attribute));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game getGameByORMID(PersistentSession session, int attribute) throws PersistentException {
		try {
			return (Game) session.get(pt.uminho.di.aa.Game.class, Integer.valueOf(attribute));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game loadGameByORMID(PersistentSession session, int attribute, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Game) session.load(pt.uminho.di.aa.Game.class, Integer.valueOf(attribute), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Game getGameByORMID(PersistentSession session, int attribute, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Game) session.get(pt.uminho.di.aa.Game.class, Integer.valueOf(attribute), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
