...
import org.orm.*;
public class RetrieveAndUpdateAagamesData {
	...
	public static void main(String[] args) {
		try {
			RetrieveAndUpdateAagamesData retrieveAndUpdateAagamesData = new RetrieveAndUpdateAagamesData();
			try {
				retrieveAndUpdateAagamesData.retrieveAndUpdateTestData();
				//retrieveAndUpdateAagamesData.retrieveByCriteria();
			}
			finally {
