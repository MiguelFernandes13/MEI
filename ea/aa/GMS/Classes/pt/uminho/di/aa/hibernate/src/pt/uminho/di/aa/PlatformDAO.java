...
public class PlatformDAO {
	...
	public static Platform loadPlatformByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Platform) session.load(pt.uminho.di.aa.Platform.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Platform getPlatformByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Platform) session.get(pt.uminho.di.aa.Platform.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Platform loadPlatformByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Platform) session.load(pt.uminho.di.aa.Platform.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Platform getPlatformByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Platform) session.get(pt.uminho.di.aa.Platform.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
